...
%TODO: Smooth out animation timing
...
%TODO: Maybe roll into next slide? Time consuming
...
\item<+-> \(pi <_w e\) is false ($\bot$)\hspace{1.63in}\includegraphics[width=1.875in]{img/interval1.png}
\item<+-> \(pi <_w e + 3\) is true ($\top$)\hspace{1.4in}\includegraphics[width=1.875in]{img/interval2.png}
\item<+-> \(pi <_w e + 1\) is \emph{a known unknown} ($U$){\hspace{0.50875in}\includegraphics[width=1.40625in]{img/interval3.png}}
\end{itemize}
...
%TODO: Can this merge into sandbox slide?
...
%TODO: Move to discussion of proposed stuff?
...
%TODO: Adjust colors for proposed / ongoing / finished / omitted-from-talk status
...
\end{center}
\end{frame}
% TODO: Clarify finished vs. ongoing
...
% What's next: ODE's
%TODO: Reduce time. Is example needed? Can we do 2D car example?
...
\begin{itemize}
%TODO: Differentiate necessary vs. for-fun proofs
...
%TODO: Spacing and formatting of characters
...
%TODO: Time consuming? Lots of text?
...
%TODO: Lots of text, lots of jumpy transitions
