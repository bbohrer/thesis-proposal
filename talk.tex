...
% TODO: What did completed work teach us about how we need to do different
...
%TODO: Cleaner formatting, animate in tips for pacing, introduce constructs
...
%TODO: Careful intro Angel and Demon at right time
...
\begin{frame}[t]{Game Model is Victorious}
\noindent
\begin{center}
\includegraphics[width=0.4\textwidth]{graphics/fig-ode2.pdf}\\
{\small\begin{align*}
...
\end{align*}}%
\begin{align*}
\textsf{Safe} &\equiv \ddiamond{\prepeat{(\ctrlcolor{\ctrl};\plantcolor{\plant})}}{\textsf{safe}}\\
\textsf{Live} &\equiv \dbox{\drepeat{(\ctrlcolor{\ctrl};\plantcolor{\plant})}}{\textsf{goal}}\\
\textsf{Win}  &\equiv \ddiamond{\prepeat{(\ctrlcolor{\ctrl};\plantcolor{\plant};\ptest{\textsf{safe}})}}{\textsf{goal}}%
\end{align*}
\end{center}
\end{frame}

%TODO: Define early: what is monitor, what is control, why do we want both
...
%TODO: Discuss limitations discovered about arithmetic and code generation
