...
%Read it. When {p}S{q} and {p1}S{q1} are equitrue for all S, want derivation of the {p1}S{q1} from {p}S{q}. Main place this doesn't hold in basic
%Hoare logics is when p,q talk about variables that are ghosts or otherwise not mentioned in S. 
%Will have to think about how to do that in CdGL, maybe by monotoniticy, not by V because that's CdL.
