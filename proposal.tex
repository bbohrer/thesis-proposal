...
Soundness validates the basic correctness of the calculus while equi-expressiveness says that decidability results for \dL also apply to \dLe because provable \dLe formulas can be translated to provable \dL formulas.
