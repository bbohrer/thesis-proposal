...
%TODO: Read Kleymann99 VDM, state describe and state prop for Kaisar
We also wish to state and prove \emph{adaptation completeness}~\cite{DBLP:journals/fac/Kleymann99},a formal property which attests the modularity that we've gained by supporting lexical scope.
...
%TODO: Make sure we proved CdGL is undecidable.
However, this approach does not apply to undecidable logics such as \CdGL.
