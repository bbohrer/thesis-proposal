...
%\newcommand{\dRL}{\textsf{dRL}\xspace}
...
Constructive reals have been implemented efficiently in theorem provers, for example the CORN~\cite{DBLP:journals/corr/abs-11063-448,Krebbers+Spitters:lmcs:corn:2011} library.
...
Validity of \irref{dglind} follows from the Mean-Value Theorem or its generalization, Rolle's Theorem, which has been proven constructively~\cite{DBLP:journals/corr/abs-11063-448,Krebbers+Spitters:lmcs:corn:2011}.
...
This is a natural variation on the proposition $L$ of hybrid logic which holds true exactly \emph{at} state $L,$ and is useful for example in Owicki-Gries reasoning, where it is known to be the \emph{only} kind of ghosting necessary for completeness. %TODO: Cite lamport
