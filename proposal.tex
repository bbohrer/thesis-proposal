...
The KeY prover~\cite{DBLP:series/lncs/10001} features a soundness-critical ``tactlet''~\cite{habermalz2000interactiv} language with limited expressivity, which can be understood as specifying new inference rules.
